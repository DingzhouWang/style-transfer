...
def main():
    ...
    with tf.Session() as sess:
        ...
        # ckpt = tf.train.get_checkpoint_state('D:/Python/HOT_NET/Transfer/model')
        # if ckpt != None:
        ...
        for i in range(ITERATION):
            ...
            if i % 100 == 0:
                ...
                pic[1] += 117
                pic[2] += 104
                cv2.imwrite('D:/tmp/results/%d.jpg' % i, cv2.resize(pic, (Ratio[1], Ratio[0])))
        saver.save(sess, "D:/tmp/transfer/model.ckpt")
